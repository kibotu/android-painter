...
public class Matrix4 implements Serializable {
     ...
     * matrices as you can get from {@link net.kibotu.de.infoini.door.graphic.Matrix4#val}. This is the same as {@link net.kibotu.de.infoini.door.graphic.Matrix4#mul(net.kibotu.de.infoini.door.graphic.Matrix4)}.
     *
	...
	*/
     ...
     * from {@link net.kibotu.de.infoini.door.graphic.Matrix4#val}. The vector array is assumed to hold a 3-component vector, with x being the first element, y being
     * the second and z being the last component. The result is stored in the vector array. This is the same as
     * {@link Vector3#mul(net.kibotu.de.infoini.door.graphic.Matrix4)}.
     *
     * @param mat the matrix
	...
	*/
     ...
     * from {@link net.kibotu.de.infoini.door.graphic.Matrix4#val}. The vectors array is assumed to hold 3-component vectors. Offset specifies the offset into the
     ...
     * the same as {@link Vector3#mul(net.kibotu.de.infoini.door.graphic.Matrix4)} applied to multiple vectors.
     *
     * @param mat     the matrix
	...
	*/
     ...
     * major matrix as you can get from {@link net.kibotu.de.infoini.door.graphic.Matrix4#val}. The vector array is assumed to hold a 3-component vector, with x being
     * the first element, y being the second and z being the last component. The result is stored in the vector array. This is the
     * same as {@link Vector3#prj(net.kibotu.de.infoini.door.graphic.Matrix4)}.
     *
     * @param mat the matrix
     * @param vec the vector.
     */
	...
	*/
     ...
     * major matrix as you can get from {@link net.kibotu.de.infoini.door.graphic.Matrix4#val}. The vectors array is assumed to hold 3-component vectors. Offset
     ...
     * vectors and must be >= 3. This is the same as {@link Vector3#prj(net.kibotu.de.infoini.door.graphic.Matrix4)} applied to multiple vectors.
     *
     * @param mat     the matrix
     * @param vecs    the vectors
     * @param offset  the offset into the vectors array
	...
	*/
     ...
     * major matrix as you can get from {@link net.kibotu.de.infoini.door.graphic.Matrix4#val}. The vector array is assumed to hold a 3-component vector, with x being
     * the first element, y being the second and z being the last component. The result is stored in the vector array. This is the
     * same as {@link Vector3#rot(net.kibotu.de.infoini.door.graphic.Matrix4)}.
     *
     * @param mat the matrix
     * @param vec the vector.
     */
	...
	*/
     ...
     * column major matrix as you can get from {@link net.kibotu.de.infoini.door.graphic.Matrix4#val}. The vectors array is assumed to hold 3-component vectors.
     ...
     * subsequent vectors and must be >= 3. This is the same as {@link Vector3#rot(net.kibotu.de.infoini.door.graphic.Matrix4)} applied to multiple vectors.
     *
     * @param mat     the matrix
     * @param vecs    the vectors
     * @param offset  the offset into the vectors array
	...
	*/
     ...
     * {@link net.kibotu.de.infoini.door.graphic.Matrix4#val}.
     *
	...
	*/
     ...
     * from {@link net.kibotu.de.infoini.door.graphic.Matrix4#val}.
     *
     * @param values the matrix values.
     *
